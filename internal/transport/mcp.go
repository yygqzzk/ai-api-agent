// Package transport provides HTTP transport layer for the application.
package transport
...
func NewServer(cfg config.Config, registry *tool.Registry, hooks Hooks, options ServerOptions) *Server {
