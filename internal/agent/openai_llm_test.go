...
func TestOpenAICompatibleLLMClientTextReply(t *testing.T) {
  ...
  "choices": [{"message": {"role": "assistant", "content": "ok-summary"}}]
	...
	reply, err := client.Next(context.Background(), []Message{{Role: "user", Content: "hi"}}, nil)
	if err != nil {
...
func TestOpenAICompatibleLLMClientToolCalls(t *testing.T) {
  ...
  "choices": [{
	...
	reply, err := client.Next(context.Background(), []Message{{Role: "user", Content: "查登录接口"}}, []ToolDefinition{{
		Name:        "search_api",
		Description: "search",
...
func TestOpenAICompatibleLLMClientHTTPErr(t *testing.T) {
	...
	_, err := client.Next(context.Background(), []Message{{Role: "user", Content: "hi"}}, nil)
	if err == nil {
...
func TestOpenAICompatibleLLMClientContextDeadlineNoRetry(t *testing.T) {
	...
	_, err := client.Next(ctx, []Message{{Role: "user", Content: "hi"}}, nil)
	if err == nil {
