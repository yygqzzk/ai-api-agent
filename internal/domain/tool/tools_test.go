...
func TestRegistryAndCoreTools(t *testing.T) {
	...
	// NOTE: match_skill tool was removed during hexagonal architecture refactoring
	// TODO: Re-implement skill matching functionality if needed
...
func setupRegistry(t *testing.T) *Registry {
	...
	kb := NewKnowledgeBaseWithIngestor(knowledge.NewMemoryIngestor(), rag.NewMemoryStore())
